...
```php
\srag\DIC\HelpMe\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\HelpMe\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\HelpMe\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
