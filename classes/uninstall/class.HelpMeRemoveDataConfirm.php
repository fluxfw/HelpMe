...
class HelpMeRemoveDataConfirm {
	...
	protected function confirmRemoveData() {
		...
		$confirmation->setHeaderText(self::translate("srsu_uninstall_confirm_remove_data"));

		$confirmation->addItem("_", "_", self::translate("srsu_uninstall_data"));

		$confirmation->addButton(self::translate("srsu_uninstall_remove_data"), self::CMD_SET_REMOVE_DATA);
		$confirmation->addButton(self::translate("srsu_uninstall_keep_data"), self::CMD_SET_KEEP_DATA);
		$confirmation->addButton(self::translate("srsu_uninstall_deactivate"), self::CMD_DEACTIVATE);
		$confirmation->setCancel(self::translate("srsu_cancel"), self::CMD_CANCEL);
	...
	protected function setKeepData() {
		HelpMeConfig::setUninstallRemoveData(false);

		ilUtil::sendInfo(self::translate("srsu_uninstall_msg_kept_data"), true);
	...
	protected function setRemoveData() {
		HelpMeConfig::setUninstallRemoveData(true);

		ilUtil::sendInfo(self::translate("srsu_uninstall_msg_removed_data"), true);
