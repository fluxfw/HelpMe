...
class ConfigFormGUI extends ActiveRecordConfigFormGUI {
	...
	protected function initForm()/*: void*/ {
		...
		$send_email_address->setValue(Config::getField(Config::KEY_SEND_EMAIL_ADDRESS));
		...
		$jira_domain->setValue(Config::getField(Config::KEY_JIRA_DOMAIN));
		...
		$jira_issue_type->setValue(Config::getField(Config::KEY_JIRA_ISSUE_TYPE));
		...
		$jira_authorization->setValue(Config::getField(Config::KEY_JIRA_AUTHORIZATION));
		...
		$jira_username->setValue(Config::getField(Config::KEY_JIRA_USERNAME));
		...
		$jira_password->setValue(Config::getField(Config::KEY_JIRA_PASSWORD));
		...
		$jira_consumer_key->setValue(Config::getField(Config::KEY_JIRA_CONSUMER_KEY));
		...
		$jira_private_key->setValue(Config::getField(Config::KEY_JIRA_PRIVATE_KEY));
		...
		$jira_access_token->setValue(Config::getField(Config::KEY_JIRA_ACCESS_TOKEN));
		...
		$info->setValue(Config::getField(Config::KEY_INFO));
		$this->addItem($info);
	...
	public function updateConfig()/*: void*/ {
		...
		Config::setField(Config::KEY_RECIPIENT, $recipient);

		$send_email_address = $this->getInput(Config::KEY_SEND_EMAIL_ADDRESS);
		Config::setField(Config::KEY_SEND_EMAIL_ADDRESS, $send_email_address);

		$jira_domain = $this->getInput(Config::KEY_JIRA_DOMAIN);
		Config::setField(Config::KEY_JIRA_DOMAIN, $jira_domain ?? "");

		$jira_issue_type = $this->getInput(Config::KEY_JIRA_ISSUE_TYPE);
		Config::setField(Config::KEY_JIRA_ISSUE_TYPE, $jira_issue_type ?? "");

		$jira_authorization = $this->getInput(Config::KEY_JIRA_AUTHORIZATION);
		Config::setField(Config::KEY_JIRA_AUTHORIZATION, $jira_authorization ?? "");

		$jira_username = $this->getInput(Config::KEY_JIRA_USERNAME);
		Config::setField(Config::KEY_JIRA_USERNAME, $jira_username ?? "");

		$jira_password = $this->getInput(Config::KEY_JIRA_PASSWORD);
		Config::setField(Config::KEY_JIRA_PASSWORD, $jira_password ?? "");

		$jira_consumer_key = $this->getInput(Config::KEY_JIRA_CONSUMER_KEY);
		Config::setField(Config::KEY_JIRA_CONSUMER_KEY, $jira_consumer_key ?? "");

		$jira_private_key = $this->getInput(Config::KEY_JIRA_PRIVATE_KEY);
		Config::setField(Config::KEY_JIRA_PRIVATE_KEY, $jira_private_key ?? "");

		$jira_access_token = $this->getInput(Config::KEY_JIRA_ACCESS_TOKEN);
		Config::setField(Config::KEY_JIRA_ACCESS_TOKEN, $jira_access_token ?? "");

		$priorities = $this->getInput(Config::KEY_PRIORITIES);
		Config::setField(Config::KEY_PRIORITIES, $priorities);

		$info = $this->getInput(Config::KEY_INFO);
		Config::setField(Config::KEY_INFO, $info);
		...
		Config::setField(Config::KEY_ROLES, $roles);
	}
}
