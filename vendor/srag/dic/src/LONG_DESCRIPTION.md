...
```php
use srag\DIC\HelpMe\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\HelpMe\x\Version\PluginVersionParameter;
...
